...
/// Aufklappbare Ergebnisanzeige pro Wegpunkt.
/// Zeigt alle Felder der Tidenberechnung aus der Excel-Mappe.
struct RouteDetailView: View {
    ...
    private var disclaimerBanner: some View {
        HStack(spacing: 10) {
            ...
            Text(
                "Diese Berechnung ist nur eine Planungshilfe und ersetzt keine amtlichen nautischen Veröffentlichungen, "
                + "aktuellen Bekanntmachungen, Revierinformationen, Wetterbeurteilung oder die Verantwortung der Schiffsführung."
            )
